...
QUnit.module('Проверка работы функции filter', function () {
  ...
  QUnit.test('filter обрабатывает текст с разрешенными тегами', function (assert) {
  ...
  QUnit.test('filter обрабатывает ошибку, где вместо текста передали число', function (assert) {
      const input = 1;
  ...
  QUnit.test('filter обрабатывает ошибку, где вместо массива тэгов передали число', function (assert) {
      const input = '<strong><em>Hello!</em></strong>';
